...
public class Author {
    /*
You are an author. You are writing a book and want to figure out some information related to
the genre of book you are writing.

Given the genre name figure out: average page length, average profit, average number of sequels,
average number of countries published in. Find and print the information based on the genre.
...
Make variables for all of that information. Given empty defaults for all the variables
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Select a literary genre to learn more");
        ...
        System.out.println("Genre: " + genre + "\naverage page length: " + pageLength +"\naverage profit:" + profit +
