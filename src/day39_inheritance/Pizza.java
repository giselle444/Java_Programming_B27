 ...
 */
    ...
    */
    ...
    public Pizza(String size, int numberOfToppings){ //the constructor is a block of code being run when object Pizza is created
        setSize(size);
        setNumberOfToppings(numberOfToppings); //callings setters
    }
