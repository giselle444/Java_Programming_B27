...
public class CharIncrement {
    public static void main(String[] args) {
        ...
        System.out.println((int)digits); // cast the character to an int, which means that this prints the ascii number for
        //that character
        System.out.println("----------");

        System.out.println(65);
        System.out.println((char)65); //int 65 to char, it will print the character "A" which has the ascii number 65
