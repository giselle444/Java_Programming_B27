...
public class ForLoopFLow {
    public static void main(String[] args) {
        ...
        int i = 0
        -> declaring and assigning a variable to be used in the loop. this is the variable that is usually used to keep track of the iterations
        -> initialization occurs once in the beginning of the loop

        2) termination condition/boolean value is checked
            -> if the boolean is true: code inside of the loop is executed
