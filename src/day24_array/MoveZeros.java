...
Hint: You don’t have to manipulate the given array, try to use another array too. Think about the indexes
    ...
    public static void main(String[] args) {
        ...
        int indexToRead= 0; //read every element from beginning to end --> same as i in a trad loop
        int indexToStore= 0; //store values into fixed array, maybe will not increment each time
