...
public class Cities {
    public static void main(String[] args) {
        ...
        //access and print each city one at a time
        ...
        System.out.println(cities); // not readable, prints hashcodes --> @%17ee1cb82*!
        System.out.println(Arrays.toString(cities)); // --> return your array object as in a string format
