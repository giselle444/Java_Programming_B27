...
public class Book {
    public static void main(String[] args) {
        ...
        for (int i = 0; i< chapters; i++){
            ...
            book[i]= input.nextLine().trim().split(" "); // reading a string from the console then trimming the extra spaces in the beginniung and end and finally splitting the array by the spaces, getting a String array with each word as a seperate element. That String array is stored into the book 2D array
